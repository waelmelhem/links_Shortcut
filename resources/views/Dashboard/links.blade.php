                        ...
                        <tbody>
                            ...
                            @foreach ($links as $link)
                                <tr>
                                    ...
                                    <td> 
                                        <a href="{{ url('dashboard/edit/' .$link->New_Path) }}" class="btn btn-secondary">Edit</a>
                                        <span style="inline">
                                        <form style="display: inline;" action="{{ route('dashboard.delete') }}" method="POST">  
                                            @csrf
                                            <input type="hidden" name="New_Path" value="{{ $link->New_Path }}"/> 
